...
if __name__ == "__main__":
    ...
    train_names, train_labels = load_data_file("datasets/Binary/train.txt")
    ...
    # )
    val_names, val_labels = load_data_file("datasets/Binary/val.txt")
    ...
    # Test the model
    test_acc, _, prediction_probs = test(
        model=model,
        config=config,
    ...
    # Test the model
    test_acc_tta, _, tta_prediction_probs = test(
        model=model,
        config=config,
        data_file="datasets/Binary/val.txt",
        data_root=args.data_root,
